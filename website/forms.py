...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        ...
        def __init__(self, *args, **kwargs):
            ...
            # we are doing what we did for email, first_name etc. for username and passwords
            # allows us to add anything we want
...
class AddRecordForm(forms.ModelForm):  # ModelForm will take a form submission and add it to a model
